...
export const SITE: Site = {
    author: "Hung Nguyen",
    url: "https://nghiahung.dev",
    title: "nghiahung.dev",
    description:
        "Hung Nguyen's personal blog, I enjoy the process of building something using any technology stack",
    shortDescription: "",
};
...
export const NavigationLinks: NavigationLink[] = [
    ...
    { name: "About", url: "/posts/about-hung" },
...
export const FooterLinks = [
    {
        ...
        links: [
            ...
            { name: "About Me", url: "/posts/about-hung" },
        ],
    },
    {
        section: "Other",
        links: [
            ...
            { name: "Twitter", url: "https://x.com/nnhungjs" },
        ],
    },
];
...
export const Settings = {
    ...
    Assets: {
        ...
        config: {
            ...
            //
            // For example: https://images.nghiahung.dev/gblog/assets/brand-logo.webp
            //
